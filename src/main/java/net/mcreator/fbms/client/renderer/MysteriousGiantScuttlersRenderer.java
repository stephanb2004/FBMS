...
public class MysteriousGiantScuttlersRenderer extends GeoEntityRenderer<MysteriousGiantScuttlersEntity> {
	...
	@Override
	public RenderType getRenderType(MysteriousGiantScuttlersEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
