...
public class DBonnieRenderer extends GeoEntityRenderer<DBonnieEntity> {
	...
	@Override
	public RenderType getRenderType(DBonnieEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
