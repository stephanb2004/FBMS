...
public class RatEntity extends TamableAnimal implements IAnimatable {
	...
	public RatEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FbmsModEntities.RAT.get(), world);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Player.class, (float) 10, 3, 1.2));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		RatEntity retval = FbmsModEntities.RAT.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(FbmsModEntities.RAT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
