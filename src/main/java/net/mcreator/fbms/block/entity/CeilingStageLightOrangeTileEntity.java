...
public class CeilingStageLightOrangeTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<CeilingStageLightOrangeTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<CeilingStageLightOrangeTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
