...
public class HeavyDuityDoorClosedTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<HeavyDuityDoorClosedTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<HeavyDuityDoorClosedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
