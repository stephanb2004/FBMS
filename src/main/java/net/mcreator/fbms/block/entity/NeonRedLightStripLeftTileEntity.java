...
public class NeonRedLightStripLeftTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<NeonRedLightStripLeftTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<NeonRedLightStripLeftTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
