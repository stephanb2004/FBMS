...
public class CeilingStageLightblueTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<CeilingStageLightblueTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<CeilingStageLightblueTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
