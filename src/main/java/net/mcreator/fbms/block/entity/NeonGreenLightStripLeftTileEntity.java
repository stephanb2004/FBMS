...
public class NeonGreenLightStripLeftTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<NeonGreenLightStripLeftTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<NeonGreenLightStripLeftTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
