...
public class PuppetBoxTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PuppetBoxTileEntity(BlockPos pos, BlockState state) {
		super(FbmsModBlockEntities.PUPPET_BOX.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(PuppetBoxBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<PuppetBoxTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<PuppetBoxTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
