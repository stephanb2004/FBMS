...
public class NeonOrangeLightStripTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<NeonOrangeLightStripTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<NeonOrangeLightStripTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
