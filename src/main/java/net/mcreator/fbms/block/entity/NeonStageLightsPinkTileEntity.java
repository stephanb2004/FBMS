...
public class NeonStageLightsPinkTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<NeonStageLightsPinkTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<NeonStageLightsPinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
