...
public class HazyReindeerAnimatedTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<HazyReindeerAnimatedTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<HazyReindeerAnimatedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
