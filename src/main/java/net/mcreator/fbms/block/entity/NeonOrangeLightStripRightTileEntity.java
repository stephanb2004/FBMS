...
public class NeonOrangeLightStripRightTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<NeonOrangeLightStripRightTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<NeonOrangeLightStripRightTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
