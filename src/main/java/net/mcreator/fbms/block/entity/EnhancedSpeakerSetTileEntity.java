...
public class EnhancedSpeakerSetTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<EnhancedSpeakerSetTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<EnhancedSpeakerSetTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
