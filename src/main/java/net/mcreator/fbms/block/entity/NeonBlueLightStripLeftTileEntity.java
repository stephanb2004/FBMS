...
public class NeonBlueLightStripLeftTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<NeonBlueLightStripLeftTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<NeonBlueLightStripLeftTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
