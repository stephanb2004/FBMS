...
public class MoldyRabbitTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public MoldyRabbitTileEntity(BlockPos pos, BlockState state) {
		super(FbmsModBlockEntities.MOLDY_RABBIT.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(MoldyRabbitBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<MoldyRabbitTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<MoldyRabbitTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("moldy_rabbit");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Moldy Spring Bonnie Cutout");
	}
