...
public class FruityMazeTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FruityMazeTileEntity(BlockPos pos, BlockState state) {
		super(FbmsModBlockEntities.FRUITY_MAZE.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FruityMazeBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FruityMazeTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FruityMazeTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fruity_maze");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Fruity Maze");
	}
