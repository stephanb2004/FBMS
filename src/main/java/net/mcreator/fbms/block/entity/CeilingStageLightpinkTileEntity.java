...
public class CeilingStageLightpinkTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<CeilingStageLightpinkTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<CeilingStageLightpinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
