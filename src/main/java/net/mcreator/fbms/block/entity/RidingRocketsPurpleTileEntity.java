...
public class RidingRocketsPurpleTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<RidingRocketsPurpleTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<RidingRocketsPurpleTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
