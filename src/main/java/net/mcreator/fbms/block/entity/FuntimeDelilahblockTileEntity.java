...
public class FuntimeDelilahblockTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<FuntimeDelilahblockTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<FuntimeDelilahblockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
