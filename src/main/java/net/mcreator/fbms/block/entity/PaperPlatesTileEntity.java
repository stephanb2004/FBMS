...
public class PaperPlatesTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PaperPlatesTileEntity(BlockPos pos, BlockState state) {
		super(FbmsModBlockEntities.PAPER_PLATES.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(PaperPlatesBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<PaperPlatesTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<PaperPlatesTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("paper_plates");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Paper Cups and Plates");
	}
