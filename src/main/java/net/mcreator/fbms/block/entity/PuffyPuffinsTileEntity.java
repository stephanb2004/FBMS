...
public class PuffyPuffinsTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PuffyPuffinsTileEntity(BlockPos pos, BlockState state) {
		super(FbmsModBlockEntities.PUFFY_PUFFINS.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(PuffyPuffinsBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<PuffyPuffinsTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<PuffyPuffinsTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("puffy_puffins");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Puffy Puffins");
	}
