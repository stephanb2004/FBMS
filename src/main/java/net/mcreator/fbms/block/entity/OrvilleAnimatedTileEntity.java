...
public class OrvilleAnimatedTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<OrvilleAnimatedTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<OrvilleAnimatedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
