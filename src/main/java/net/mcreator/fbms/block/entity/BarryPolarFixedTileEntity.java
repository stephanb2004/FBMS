...
public class BarryPolarFixedTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<BarryPolarFixedTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<BarryPolarFixedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
