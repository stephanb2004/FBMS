...
public class NeonRedLightStripRightTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<NeonRedLightStripRightTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<NeonRedLightStripRightTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
