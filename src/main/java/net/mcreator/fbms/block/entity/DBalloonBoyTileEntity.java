...
public class DBalloonBoyTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public DBalloonBoyTileEntity(BlockPos pos, BlockState state) {
		super(FbmsModBlockEntities.D_BALLOON_BOY.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(DBalloonBoyBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<DBalloonBoyTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<DBalloonBoyTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("d_balloon_boy");
	}
	...
	public Component getDisplayName() {
		return Component.literal("D Balloon Boy");
	}
