...
public class NeonYellowLightStripLeftTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<NeonYellowLightStripLeftTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<NeonYellowLightStripLeftTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
