...
public class NeonBlueLightStripRightTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<NeonBlueLightStripRightTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<NeonBlueLightStripRightTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
