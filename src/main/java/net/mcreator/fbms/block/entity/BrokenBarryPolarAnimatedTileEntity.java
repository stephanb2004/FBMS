...
public class BrokenBarryPolarAnimatedTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<BrokenBarryPolarAnimatedTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<BrokenBarryPolarAnimatedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
