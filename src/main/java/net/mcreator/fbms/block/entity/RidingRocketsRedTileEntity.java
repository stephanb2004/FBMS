...
public class RidingRocketsRedTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<RidingRocketsRedTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<RidingRocketsRedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
