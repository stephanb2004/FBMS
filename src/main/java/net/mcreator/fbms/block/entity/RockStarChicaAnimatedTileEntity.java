...
public class RockStarChicaAnimatedTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<RockStarChicaAnimatedTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<RockStarChicaAnimatedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
