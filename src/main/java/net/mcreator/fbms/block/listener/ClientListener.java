...
public class ClientListener {
	...
	public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_STAGE_LIGHTS_ORANGE.get(), NeonStageLightsOrangeTileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.CEILING_STAGE_LIGHT_ORANGE.get(), CeilingStageLightOrangeTileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.FUNTIME_CHICA.get(), FunTimeChicaTileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.BARRY_POLAR.get(), BarryPolarFixedTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.WITHERED_BARRY_POLAR.get(), BarryPolarTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.FUNTIME_DELILAH.get(), FuntimeDelilahblockTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.WALLY_WALRUS.get(), WallyWalrusTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.PUFFY_PUFFINS.get(), PuffyPuffinsTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.HAZY_REINDEER.get(), HazyReindeerTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.WITHERED_WALLY_WALRUS.get(), WitheredWallyWalrusTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.WITHERED_PUFFY_PUFFINS.get(), WitheredPuffyPuffinsTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.WITHERED_HAZY_REINDEER.get(), WitheredHazyReindeerTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.GT_ENDO.get(), GtEndoTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.ST_ENDO.get(), StEndoTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.BUFFET_ENDO.get(), BuffetEndoTileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.JOLLY_THE_RAT.get(), JollyTheRatTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.SALVAGED_JOLLY.get(), SalvagedJollyTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.GUS_THE_PUG.get(), GusThePugTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.FREDBEAR_01.get(), Fredbear01TileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.SPRINGBONNIE_01.get(), Springbonnie01TileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.JEFFS_PIZZA_SIGN.get(), JeffsPizzaSignTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.LOLBIT_RECORD.get(), LolbitRecordTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.SIGN_DDW.get(), SignDDWTileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.PROJECTOR.get(), ProjectorTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.CAM.get(), CamTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.FREDDY_CUT_OUT.get(), FreddyCutOutTileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.WITHERED_BARRY_POLAR_ANIMATED.get(), BrokenBarryPolarAnimatedTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.FUNTIME_DELILAH_ANIMATED.get(), FuntimeDelilahTileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.HAPPY_FROG_ANIMATED.get(), HappYFrogAnimatedTileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.HAZY_REINDEER_ANIMATED.get(), HazyReindeerAnimatedTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.WALLY_WALRUS_ANIMATED.get(), WallyWalrusAnimatedTileRenderer::new);
		...
		event.registerBlockEntityRenderer(FbmsModBlockEntities.FREDBEAR_01_ANIMATED.get(), Fredbear01AnimatedTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.SPRINGBONNIE_01_ANIMATED.get(), Springbonnie01AnimatedTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.TOY_PUG.get(), ToyPugTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.PRIZE_COUNTER_SIGN.get(), PrizeCounterSignTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.REST_ROOM_SIGN.get(), RestRoomSignTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.ARCADE_SIGN.get(), ArcadeSignTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.PARTY_ROOM_SIGN.get(), PartyRoomSignTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.KITCHEN_SIGN.get(), KitchenSignTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_RED_LIGHT_STRIP.get(), NeonRedLightStripTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_RED_LIGHT_STRIP_RIGHT.get(), NeonRedLightStripRightTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_RED_LIGHT_STRIP_LEFT.get(), NeonRedLightStripLeftTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_GREEN_LIGHT_STRIP.get(), NeonGreenLightStripTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_GREEN_LIGHT_STRIP_RIGHT.get(), NeonGreenLightStripRightTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_GREEN_LIGHT_STRIP_LEFT.get(), NeonGreenLightStripLeftTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_BLUE_LIGHT_STRIP.get(), NeonBlueLightStripTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_BLUE_LIGHT_STRIP_RIGHT.get(), NeonBlueLightStripRightTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_BLUE_LIGHT_STRIP_LEFT.get(), NeonBlueLightStripLeftTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_YELLOW_LIGHT_STRIP.get(), NeonYellowLightStripTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_YELLOW_LIGHT_STRIP_RIGHT.get(), NeonYellowLightStripRightTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_YELLOW_LIGHT_STRIP_LEFT.get(), NeonYellowLightStripLeftTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_ORANGE_LIGHT_STRIP.get(), NeonOrangeLightStripTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_ORANGE_LIGHT_STRIP_RIGHT.get(), NeonOrangeLightStripRightTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.NEON_ORANGE_LIGHT_LEFT.get(), NeonOrangeLightLeftTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.FT_FREDDY.get(), FtFreddyTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.FRED_BEAR.get(), FredBearTileRenderer::new);
		event.registerBlockEntityRenderer(FbmsModBlockEntities.FREDBEAR_DEACTIVATED.get(), FredbearDeactivatedTileRenderer::new);
	}
}
