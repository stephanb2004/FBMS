...
public class Springbonnie01BlockModel extends GeoModel<Springbonnie01TileEntity> {
	@Override
	...
	@Override
	public ResourceLocation getTextureResource(Springbonnie01TileEntity animatable) {
