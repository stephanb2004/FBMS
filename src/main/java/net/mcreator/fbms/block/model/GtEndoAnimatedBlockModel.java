...
public class GtEndoAnimatedBlockModel extends AnimatedGeoModel<GtEndoAnimatedTileEntity> {
	@Override
	...
	@Override
	public ResourceLocation getTextureResource(GtEndoAnimatedTileEntity entity) {
