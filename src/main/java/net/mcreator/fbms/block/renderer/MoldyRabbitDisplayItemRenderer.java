...
public class MoldyRabbitDisplayItemRenderer extends GeoItemRenderer<MoldyRabbitDisplayItem> {
	...
	@Override
	public RenderType getRenderType(MoldyRabbitDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
