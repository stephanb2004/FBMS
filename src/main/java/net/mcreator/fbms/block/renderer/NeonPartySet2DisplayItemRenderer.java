...
public class NeonPartySet2DisplayItemRenderer extends GeoItemRenderer<NeonPartySet2DisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonPartySet2DisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
