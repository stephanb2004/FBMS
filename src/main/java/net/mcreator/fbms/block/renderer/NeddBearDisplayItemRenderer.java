...
public class NeddBearDisplayItemRenderer extends GeoItemRenderer<NeddBearDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeddBearDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
