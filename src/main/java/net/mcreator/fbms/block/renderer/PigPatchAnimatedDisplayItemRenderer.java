...
public class PigPatchAnimatedDisplayItemRenderer extends GeoItemRenderer<PigPatchAnimatedDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PigPatchAnimatedDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
