...
public class RockStarBonnieAnimatedDisplayItemRenderer extends GeoItemRenderer<RockStarBonnieAnimatedDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RockStarBonnieAnimatedDisplayItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
