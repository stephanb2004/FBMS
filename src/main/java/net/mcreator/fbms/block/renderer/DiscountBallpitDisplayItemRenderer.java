...
public class DiscountBallpitDisplayItemRenderer extends GeoItemRenderer<DiscountBallpitDisplayItem> {
	...
	@Override
	public RenderType getRenderType(DiscountBallpitDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
