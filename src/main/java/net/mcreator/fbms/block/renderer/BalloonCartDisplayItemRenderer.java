...
public class BalloonCartDisplayItemRenderer extends GeoItemRenderer<BalloonCartDisplayItem> {
	...
	@Override
	public RenderType getRenderType(BalloonCartDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
