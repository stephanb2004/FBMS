...
public class CeilingStageLightsDisplayItemRenderer extends GeoItemRenderer<CeilingStageLightsDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CeilingStageLightsDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
