...
public class RockStarFoxyAnimatedDisplayItemRenderer extends GeoItemRenderer<RockStarFoxyAnimatedDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RockStarFoxyAnimatedDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
