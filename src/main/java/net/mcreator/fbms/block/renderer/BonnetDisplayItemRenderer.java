...
public class BonnetDisplayItemRenderer extends GeoItemRenderer<BonnetDisplayItem> {
	...
	@Override
	public RenderType getRenderType(BonnetDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
