...
public class RestRoomSignDisplayItemRenderer extends GeoItemRenderer<RestRoomSignDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RestRoomSignDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
