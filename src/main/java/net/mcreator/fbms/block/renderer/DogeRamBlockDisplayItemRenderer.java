...
public class DogeRamBlockDisplayItemRenderer extends GeoItemRenderer<DogeRamBlockDisplayItem> {
	...
	@Override
	public RenderType getRenderType(DogeRamBlockDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
