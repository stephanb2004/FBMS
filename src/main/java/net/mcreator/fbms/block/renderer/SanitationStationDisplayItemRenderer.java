...
public class SanitationStationDisplayItemRenderer extends GeoItemRenderer<SanitationStationDisplayItem> {
	...
	@Override
	public RenderType getRenderType(SanitationStationDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
