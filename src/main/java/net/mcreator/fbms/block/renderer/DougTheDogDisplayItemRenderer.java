...
public class DougTheDogDisplayItemRenderer extends GeoItemRenderer<DougTheDogDisplayItem> {
	...
	@Override
	public RenderType getRenderType(DougTheDogDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
