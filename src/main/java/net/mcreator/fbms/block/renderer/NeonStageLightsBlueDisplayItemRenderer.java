...
public class NeonStageLightsBlueDisplayItemRenderer extends GeoItemRenderer<NeonStageLightsBlueDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonStageLightsBlueDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
