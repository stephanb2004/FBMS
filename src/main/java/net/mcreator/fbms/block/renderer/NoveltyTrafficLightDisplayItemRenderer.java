...
public class NoveltyTrafficLightDisplayItemRenderer extends GeoItemRenderer<NoveltyTrafficLightDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NoveltyTrafficLightDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
