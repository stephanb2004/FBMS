...
public class GarfPlushDisplayItemRenderer extends GeoItemRenderer<GarfPlushDisplayItem> {
	...
	@Override
	public RenderType getRenderType(GarfPlushDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
