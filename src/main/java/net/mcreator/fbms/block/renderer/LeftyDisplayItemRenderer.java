...
public class LeftyDisplayItemRenderer extends GeoItemRenderer<LeftyDisplayItem> {
	...
	@Override
	public RenderType getRenderType(LeftyDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
