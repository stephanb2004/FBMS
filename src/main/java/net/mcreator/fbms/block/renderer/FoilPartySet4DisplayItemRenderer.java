...
public class FoilPartySet4DisplayItemRenderer extends GeoItemRenderer<FoilPartySet4DisplayItem> {
	...
	@Override
	public RenderType getRenderType(FoilPartySet4DisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
