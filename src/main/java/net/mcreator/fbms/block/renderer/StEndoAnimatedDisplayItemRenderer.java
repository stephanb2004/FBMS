...
public class StEndoAnimatedDisplayItemRenderer extends GeoItemRenderer<StEndoAnimatedDisplayItem> {
	...
	@Override
	public RenderType getRenderType(StEndoAnimatedDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
