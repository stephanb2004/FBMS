...
public class SignSNSDisplayItemRenderer extends GeoItemRenderer<SignSNSDisplayItem> {
	...
	@Override
	public RenderType getRenderType(SignSNSDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
