...
public class FuntimeDelilahblockDisplayItemRenderer extends GeoItemRenderer<FuntimeDelilahblockDisplayItem> {
	...
	@Override
	public RenderType getRenderType(FuntimeDelilahblockDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
