...
public class DeluxeBallpitDisplayItemRenderer extends GeoItemRenderer<DeluxeBallpitDisplayItem> {
	...
	@Override
	public RenderType getRenderType(DeluxeBallpitDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
