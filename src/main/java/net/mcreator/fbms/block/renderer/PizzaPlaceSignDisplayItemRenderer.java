...
public class PizzaPlaceSignDisplayItemRenderer extends GeoItemRenderer<PizzaPlaceSignDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PizzaPlaceSignDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
