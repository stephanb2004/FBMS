...
public class PinTheBowtieOnTheFreddyDisplayItemRenderer extends GeoItemRenderer<PinTheBowtieOnTheFreddyDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PinTheBowtieOnTheFreddyDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
