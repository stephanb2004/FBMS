...
public class NeonBlueLightStripDisplayItemRenderer extends GeoItemRenderer<NeonBlueLightStripDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonBlueLightStripDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
