...
public class SecurityPuppetDisplayItemRenderer extends GeoItemRenderer<SecurityPuppetDisplayItem> {
	...
	@Override
	public RenderType getRenderType(SecurityPuppetDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
