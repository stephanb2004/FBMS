...
public class HazyReindeerDisplayItemRenderer extends GeoItemRenderer<HazyReindeerDisplayItem> {
	...
	@Override
	public RenderType getRenderType(HazyReindeerDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
