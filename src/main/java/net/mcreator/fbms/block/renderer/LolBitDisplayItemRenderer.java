...
public class LolBitDisplayItemRenderer extends GeoItemRenderer<LolBitDisplayItem> {
	...
	@Override
	public RenderType getRenderType(LolBitDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
