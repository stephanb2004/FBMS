...
public class ScrapTrapDisplayItemRenderer extends GeoItemRenderer<ScrapTrapDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ScrapTrapDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
