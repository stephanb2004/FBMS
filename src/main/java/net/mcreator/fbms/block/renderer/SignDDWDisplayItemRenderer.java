...
public class SignDDWDisplayItemRenderer extends GeoItemRenderer<SignDDWDisplayItem> {
	...
	@Override
	public RenderType getRenderType(SignDDWDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
