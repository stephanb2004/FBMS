...
public class RidingRocketsPurpleDisplayItemRenderer extends GeoItemRenderer<RidingRocketsPurpleDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RidingRocketsPurpleDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
