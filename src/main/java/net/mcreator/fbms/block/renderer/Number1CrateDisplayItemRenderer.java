...
public class Number1CrateDisplayItemRenderer extends GeoItemRenderer<Number1CrateDisplayItem> {
	...
	@Override
	public RenderType getRenderType(Number1CrateDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
