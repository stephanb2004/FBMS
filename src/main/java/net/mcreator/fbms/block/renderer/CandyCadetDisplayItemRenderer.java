...
public class CandyCadetDisplayItemRenderer extends GeoItemRenderer<CandyCadetDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CandyCadetDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
