...
public class IgnitedChicaDisplayItemRenderer extends GeoItemRenderer<IgnitedChicaDisplayItem> {
	...
	@Override
	public RenderType getRenderType(IgnitedChicaDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
