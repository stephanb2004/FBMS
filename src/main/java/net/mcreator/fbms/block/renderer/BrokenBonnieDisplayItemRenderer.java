...
public class BrokenBonnieDisplayItemRenderer extends GeoItemRenderer<BrokenBonnieDisplayItem> {
	...
	@Override
	public RenderType getRenderType(BrokenBonnieDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
