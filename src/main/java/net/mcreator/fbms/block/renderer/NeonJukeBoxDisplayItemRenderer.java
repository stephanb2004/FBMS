...
public class NeonJukeBoxDisplayItemRenderer extends GeoItemRenderer<NeonJukeBoxDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonJukeBoxDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
