...
public class ToyFoxyDisplayItemRenderer extends GeoItemRenderer<ToyFoxyDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ToyFoxyDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
