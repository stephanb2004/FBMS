...
public class WitheredDougTheDogDisplayItemRenderer extends GeoItemRenderer<WitheredDougTheDogDisplayItem> {
	...
	@Override
	public RenderType getRenderType(WitheredDougTheDogDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
