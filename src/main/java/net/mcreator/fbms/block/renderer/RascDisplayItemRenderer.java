...
public class RascDisplayItemRenderer extends GeoItemRenderer<RascDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RascDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
