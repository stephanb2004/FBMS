...
public class RustyDisplayItemRenderer extends GeoItemRenderer<RustyDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RustyDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
