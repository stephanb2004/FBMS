...
public class NeonJukeBoxOffDisplayItemRenderer extends GeoItemRenderer<NeonJukeBoxOffDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonJukeBoxOffDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
