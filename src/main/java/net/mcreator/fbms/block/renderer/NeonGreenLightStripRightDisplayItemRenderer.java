...
public class NeonGreenLightStripRightDisplayItemRenderer extends GeoItemRenderer<NeonGreenLightStripRightDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonGreenLightStripRightDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
