...
public class JollyTheRatDisplayItemRenderer extends GeoItemRenderer<JollyTheRatDisplayItem> {
	...
	@Override
	public RenderType getRenderType(JollyTheRatDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
