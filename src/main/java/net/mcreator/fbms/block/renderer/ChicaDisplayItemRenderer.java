...
public class ChicaDisplayItemRenderer extends GeoItemRenderer<ChicaDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ChicaDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
