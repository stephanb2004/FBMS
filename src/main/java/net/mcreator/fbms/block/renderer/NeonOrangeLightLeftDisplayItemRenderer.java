...
public class NeonOrangeLightLeftDisplayItemRenderer extends GeoItemRenderer<NeonOrangeLightLeftDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonOrangeLightLeftDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
