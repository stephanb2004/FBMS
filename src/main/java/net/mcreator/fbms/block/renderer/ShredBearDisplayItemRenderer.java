...
public class ShredBearDisplayItemRenderer extends GeoItemRenderer<ShredBearDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ShredBearDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
