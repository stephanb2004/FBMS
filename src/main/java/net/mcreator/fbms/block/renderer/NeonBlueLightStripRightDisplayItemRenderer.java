...
public class NeonBlueLightStripRightDisplayItemRenderer extends GeoItemRenderer<NeonBlueLightStripRightDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonBlueLightStripRightDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
