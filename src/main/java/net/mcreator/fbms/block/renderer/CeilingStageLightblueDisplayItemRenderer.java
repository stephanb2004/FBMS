...
public class CeilingStageLightblueDisplayItemRenderer extends GeoItemRenderer<CeilingStageLightblueDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CeilingStageLightblueDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
