...
public class PicklesDisplayItemRenderer extends GeoItemRenderer<PicklesDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PicklesDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
