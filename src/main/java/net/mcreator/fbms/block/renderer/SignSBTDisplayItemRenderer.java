...
public class SignSBTDisplayItemRenderer extends GeoItemRenderer<SignSBTDisplayItem> {
	...
	@Override
	public RenderType getRenderType(SignSBTDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
