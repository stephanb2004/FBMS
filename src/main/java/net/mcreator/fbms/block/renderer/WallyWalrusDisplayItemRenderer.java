...
public class WallyWalrusDisplayItemRenderer extends GeoItemRenderer<WallyWalrusDisplayItem> {
	...
	@Override
	public RenderType getRenderType(WallyWalrusDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
