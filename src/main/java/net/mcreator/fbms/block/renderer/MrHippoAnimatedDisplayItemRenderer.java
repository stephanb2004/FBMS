...
public class MrHippoAnimatedDisplayItemRenderer extends GeoItemRenderer<MrHippoAnimatedDisplayItem> {
	...
	@Override
	public RenderType getRenderType(MrHippoAnimatedDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
