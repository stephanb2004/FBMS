...
public class TheMangleDisplayItemRenderer extends GeoItemRenderer<TheMangleDisplayItem> {
	...
	@Override
	public RenderType getRenderType(TheMangleDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
