...
public class HeavyDuityDoorDisplayItemRenderer extends GeoItemRenderer<HeavyDuityDoorDisplayItem> {
	...
	@Override
	public RenderType getRenderType(HeavyDuityDoorDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
