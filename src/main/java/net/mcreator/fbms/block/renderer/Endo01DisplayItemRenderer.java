...
public class Endo01DisplayItemRenderer extends GeoItemRenderer<Endo01DisplayItem> {
	...
	@Override
	public RenderType getRenderType(Endo01DisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
