...
public class OldChicaDisplayItemRenderer extends GeoItemRenderer<OldChicaDisplayItem> {
	...
	@Override
	public RenderType getRenderType(OldChicaDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
