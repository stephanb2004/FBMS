...
public class EggBabyDisplayItemRenderer extends GeoItemRenderer<EggBabyDisplayItem> {
	...
	@Override
	public RenderType getRenderType(EggBabyDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
