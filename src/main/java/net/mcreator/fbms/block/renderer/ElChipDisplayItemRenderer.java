...
public class ElChipDisplayItemRenderer extends GeoItemRenderer<ElChipDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ElChipDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
