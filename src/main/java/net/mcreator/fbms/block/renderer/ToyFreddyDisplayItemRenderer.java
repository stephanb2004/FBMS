...
public class ToyFreddyDisplayItemRenderer extends GeoItemRenderer<ToyFreddyDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ToyFreddyDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
