...
public class ArcadeSignDisplayItemRenderer extends GeoItemRenderer<ArcadeSignDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ArcadeSignDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
