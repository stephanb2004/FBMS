...
public class PizzaPlaceSignOldDisplayItemRenderer extends GeoItemRenderer<PizzaPlaceSignOldDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PizzaPlaceSignOldDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
