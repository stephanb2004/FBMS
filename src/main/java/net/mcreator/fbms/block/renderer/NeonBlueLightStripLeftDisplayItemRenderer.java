...
public class NeonBlueLightStripLeftDisplayItemRenderer extends GeoItemRenderer<NeonBlueLightStripLeftDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonBlueLightStripLeftDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
