...
public class BarryPolarAnimatedDisplayItemRenderer extends GeoItemRenderer<BarryPolarAnimatedDisplayItem> {
	...
	@Override
	public RenderType getRenderType(BarryPolarAnimatedDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
