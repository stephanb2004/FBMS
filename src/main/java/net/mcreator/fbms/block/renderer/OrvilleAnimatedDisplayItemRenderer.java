...
public class OrvilleAnimatedDisplayItemRenderer extends GeoItemRenderer<OrvilleAnimatedDisplayItem> {
	...
	@Override
	public RenderType getRenderType(OrvilleAnimatedDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
