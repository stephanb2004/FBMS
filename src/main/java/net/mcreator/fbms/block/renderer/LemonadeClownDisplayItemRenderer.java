...
public class LemonadeClownDisplayItemRenderer extends GeoItemRenderer<LemonadeClownDisplayItem> {
	...
	@Override
	public RenderType getRenderType(LemonadeClownDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
