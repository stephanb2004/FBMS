...
public class BaggyMaggieDisplayItemRenderer extends GeoItemRenderer<BaggyMaggieDisplayItem> {
	...
	@Override
	public RenderType getRenderType(BaggyMaggieDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
