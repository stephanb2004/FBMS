...
public class NeonRedLightStripLeftDisplayItemRenderer extends GeoItemRenderer<NeonRedLightStripLeftDisplayItem> {
	...
	@Override
	public RenderType getRenderType(NeonRedLightStripLeftDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
