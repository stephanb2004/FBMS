...
public class ToyPugDisplayItemRenderer extends GeoItemRenderer<ToyPugDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ToyPugDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
