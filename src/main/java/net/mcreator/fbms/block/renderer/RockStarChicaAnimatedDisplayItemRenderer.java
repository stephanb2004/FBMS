...
public class RockStarChicaAnimatedDisplayItemRenderer extends GeoItemRenderer<RockStarChicaAnimatedDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RockStarChicaAnimatedDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
