...
public class Endo02DisplayItemRenderer extends GeoItemRenderer<Endo02DisplayItem> {
	...
	@Override
	public RenderType getRenderType(Endo02DisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
