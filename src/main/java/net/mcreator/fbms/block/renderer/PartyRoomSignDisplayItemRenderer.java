...
public class PartyRoomSignDisplayItemRenderer extends GeoItemRenderer<PartyRoomSignDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PartyRoomSignDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
