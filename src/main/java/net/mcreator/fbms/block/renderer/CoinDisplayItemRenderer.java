...
public class CoinDisplayItemRenderer extends GeoItemRenderer<CoinDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CoinDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
