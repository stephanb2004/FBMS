...
public class PanStanDisplayItemRenderer extends GeoItemRenderer<PanStanDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PanStanDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
